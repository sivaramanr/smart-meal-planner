...
import com.sivaramanr.mealplanner.dto.SessionRequest;
...
public class SessionController {
  ...
  private Session findSessionOrThrow(String appName, String userId, String sessionId) {
    Maybe<Session> maybeSession =
        sessionService.getSession(googleAdkReasoningEngineName, userId, sessionId, Optional.empty());
  ...
  public List<Session> listSessions(@PathVariable String appName, @PathVariable String userId) {
    ...
    Single<ListSessionsResponse> sessionsResponseSingle =
        sessionService.listSessions(googleAdkReasoningEngineName, userId);
  ...
  public Session createSessionWithId(
    ...
    try {
      Session createdSession =
          sessionService
              .createSession(googleAdkReasoningEngineName, userId, new ConcurrentHashMap<>(initialState), sessionId)
              .blockingGet();
  ...
  public Session createSession(
    ...
    try {
      ...
      Session createdSession =
          sessionService
              .createSession(googleAdkReasoningEngineName, userId, new ConcurrentHashMap<>(initialState), null)
              .blockingGet();
  ...
  public ResponseEntity<Void> deleteSession(
    ...
    try {
      ...
      sessionService.deleteSession(googleAdkReasoningEngineName, userId, sessionId).blockingAwait();
